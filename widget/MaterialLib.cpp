...
void MaterialLib::readMtl(const char* filename)
{
    ...
    if (f.fail()) cerr << "No puc obrir el fitxer de materials <" << filename << ">" << endl;
    else
    {
        ...
        while (!f.eof())
        {
            ...
            else if (cad=="Ka") f >> mat->ka.r >> mat->ka.g >> mat->ka.b;
            else if (cad=="Kd") f >> mat->kd.r >> mat->kd.g >> mat->kd.b;
            else if (cad=="Ks") f >> mat->ks.r >> mat->ks.g >> mat->ks.b;
            else if (cad=="d")
            {
                float alfa;
                f >> alfa;
            ...
            else if (cad=="Ns") f >> mat->shininess;
