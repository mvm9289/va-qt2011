...
bool Face::hit(const Ray& r, float tmin, float tmax, SurfaceHitRecord& rec) const
{
    ...
    bool intersect = rayTriangleIntersection(r, v[vertices[0]].coord, v[vertices[1]].coord, v[vertices[2]].coord, rec.p, rec.t, up, vp, false);
    if (!intersect) intersect = rayTriangleIntersection(r, v[vertices[1]].coord, v[vertices[2]].coord, v[vertices[3]].coord, rec.p, rec.t, up, vp, false);
